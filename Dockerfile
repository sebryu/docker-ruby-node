#=================================
# Docker image used for bitbucket pipelines
#=================================
# We used to install node in the past but we dont use it anymore
# Right now this image will use ruby:2.7.2 and install chrome + chromedriver to use in capybara + selenium
